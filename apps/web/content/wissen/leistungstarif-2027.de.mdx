...
<ChartFigure caption="Die sieben Netzebenen nach der Systematik des ElWG. Netzebene 7 ist die Niederspannungsebene — dort hängen Gewerbebetriebe, Werkstätten, Bäckereien, Gastronomie und Haushalte. Sie ist die Ebene, auf die der Leistungspreis ab 2027 ausgeweitet werden soll.">
  <NetzebenenGrafik />
</ChartFigure>
...
Der Musterfall ist überall derselbe, ob [Bäckerei](/branchen/baeckerei), [Gastronomie](/branchen/gastronomie), Werkstatt oder kleiner Produktionsbetrieb: Am Morgen wird aufgesperrt, und mehrere kräftige Verbraucher gehen gemeinsam an — Kompressor, Ofen, Kälteanlage, Spülmaschine.
