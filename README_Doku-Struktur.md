...
**Zweite Ausnahme seit 09.09.2026:** Für Fragen zu Bauabschnitt B24 (KI-Interface für den Kalkulator) gelten statt `Fahrplan_2026.md` zwei dedizierte Dateien — s. Einträge unten. **⚠ Sie haben verschiedenen Rang, und die Reihenfolge ist wichtig:** `B24_KI-Interface_Kalkulator.md` ist der frühe **Konzeptstand** (hält fest, entscheidet nicht), `Pflichtenheft_Kalkulator_Delta_KI-Interface.md` (seit 09.09.2026) trägt die **Entscheidungen** der darauffolgenden Advisor-Sitzung. Bei Widerspruch zwischen beiden gilt das Delta. **B24 ist seit 10.09.2026 zu grossen Teilen gebaut** (zehn Schritte, PR #169–#181): **Teil 1** (geführte Eingabe) ist bedienbar — Chat mit Datei-Upload unter `/kalkulator/projekte`, dazu eine Admin-Oberfläche für die offenen Rückfragen unter `/admin/rueckfragen`; **Teil 2** (Frage-Guidelines) ist als Mechanik gebaut und verdrahtet, die Kataloge selbst sind leer; **Teil 3** (dynamischer Report) ist unangetastet. Der Chat sammelt bislang Eingaben und rechnet noch nichts. Der Einzelnachweis je Schritt steht in `Pflichtenheft_Kalkulator_Delta_KI-Interface.md` §10.
