...
**Zweite Ausnahme seit 09.09.2026:** Für Fragen zu Bauabschnitt B24 (KI-Interface für den Kalkulator) gilt statt `Fahrplan_2026.md` die dedizierte `B24_KI-Interface_Kalkulator.md` — s. Eintrag unten. **⚠ Anders als B18 ist B24 nicht gebaut, sondern ein früher Konzeptstand** — die Datei hält fest, sie entscheidet nicht.
