...
const SYSTEM_PROMPT = [
  ...
  '',
  'supplierPriceBasis — in welcher Basis Energiepreis und Grundgebühr des LIEFERANTEN dastehen:',
  '- "net", wenn die Rechnung diese Posten ohne Umsatzsteuer ausweist (Spalte „netto", „exkl. USt",',
  '  die Umsatzsteuer kommt erst in der Summe dazu). "gross", wenn sie inklusive Umsatzsteuer',
  '  dastehen („brutto", „inkl. 20 % USt"). Übernimm die Beträge in genau dieser Basis und rechne',
  '  sie NICHT um.',
  '- "unclear", wenn die Rechnung es nicht eindeutig sagt. Rate NICHT — ein Mensch entscheidet dann.',
  '',
